---
name: superharness-test-driven-development
...
- **superharness-verification-before-completion** - Verify all tests pass before claiming success
- **superharness-systematic-debugging** - For investigating test failures and bugs
